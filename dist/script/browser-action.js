...
function initialize(){
    ...
    window.addEventListener('load', function(){
        ...
        requireMonaco().then(function(){
            ...
            document.querySelector('#editor-js').dataset.name = "txt-editor-inputarea";
            document.querySelector('#editor-css').dataset.name = "txt-editor-inputarea";
            document.querySelector('#editor-html').dataset.name = "txt-editor-inputarea";
